...
#      - "20 讲系统化课程"、"P3 扩展方向"、"GraphRAG" 等
#
# 用法示例：
#   python scripts\course\check_docs_consistency.py
#   python scripts\course\check_docs_consistency.py --output reports/verification/docs_consistency_latest.json
#
# 退出码：0 = 一致，1 = 存在不一致
# ============================================================================
