...
Usage:
    python scripts/course/export_xmind.py              # → knowforge-curriculum.xmind
    python scripts/course/export_xmind.py -o out.xmind  # custom output path
"""
import json
import zipfile
import uuid
            ...
            "children": [
                ...
                },
                {
                    ...
                    "children": [
                        ...
                        {"id":"L16f","title":"引用式复用","note":"_reference_base_version / expire_documents_for_version；未变更文档引用复用","color":PALETTE["phase4"]},
                    ]
                },
                {
